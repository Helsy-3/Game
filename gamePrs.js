...
// 1) Faire en sorte qu'une fois que l'on a joué, l'aversaire joue à son tour et de manière automatique
// 2) Prendre en compte la mana : lors d'une attaque simple on pourrait perdre 10 de mana
// 3) S'occuper de l'attaque spéciale. Idéalement chaque profile a une attaque spécial. Une attaque spéciale 
// aurait des effets supérieurs à la normale et consomme 20 de mana
// 4) Récupérer les infos du joueur adverse depuis l'API got : soit aléatoirement, soit de manière plus 
// linéaire (du personnage le plus faible au plus fort) 